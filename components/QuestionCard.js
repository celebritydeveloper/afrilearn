...
export default function QuestionCard({ options }) {
    ...
    return (
        ...
        {options.map((option, index) => (
            <TouchableOpacity style={[styles.card, global.rowSpaceBetween, { backgroundColor: option.id === selected?.id ? COLORS.lightGreen : COLORS.gray, }]} onPress={() => onSelect(option)} key={index}>
